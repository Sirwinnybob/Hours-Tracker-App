...
Write-Host "Detected Version: $versionName ($versionCode) [DEBUG]" -ForegroundColor Green
...
if (Test-Path $debugApk) {
    Write-Host "Copying Debug APK to $targetApk" -ForegroundColor Cyan
    Copy-Item $debugApk $targetApk -Force
    Write-Host "Success! Timecard Debug Update deployed." -ForegroundColor Green
}
else {
